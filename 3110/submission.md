...
```text
https://ijudge.it.kmitl.ac.th/submissions/623553/overview
```
...
```text
โจทย์ทำ program คำนวณค่าขนส่งจากต้นทางถึงปลายทาง
Input:
รับค่า str ในส่วนของต้นทางกับปลายทาง และรับค่า float  ในส่วนของ

Output:
ค่าขนส่งทศนิยม 2 ตำแหน่ง

Constraints:
โจทย์กำหนดชัดเจนเรื่องุดหมายปลายทาง ถ้าไม่ตรงควร Error
```
...
```text
Step 1: รับค่า str ในส่วนของต้นทางกับปลายทาง และรับค่า float  ในส่วนของน้ำหนักสินค้า
Step 2: คิดคำนวณของแต่ละกรณีไว้
Step 3: เช็คเงื่อนไขตามจุดเริ่มและจุดปลาย
Step 4: คำนวณตามเงื่อนไข
Step 5: print เป็น ทศนิยม 2  ตำแหน่ง
```
