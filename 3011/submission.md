...
```text
https://ijudge.it.kmitl.ac.th/submissions/551635/overview
```
...
```text
โจทย์ให้สร้าง Program ในการผสมสี โดยใช้แม่สีเท่านั้น แล้วให้บอกมาว่าจะได้สีอะไร
 
Input:
รับค่าของแม่สีสองสีที่ต้องการนำมาผสม

Output:
Program จะบอกผลของการผสมออกมา สีแดง มารวมกับสีเหลือง จะได้สีส้ม, สีแดง มารวมกับสีน้ำเงิน จะได้สีม่วง, สีเหลือง มารวมกับสีน้ำเงิน จะได้สีเขียว ถ้าไม่ตรงเลยจะได้ Error 

Constraints:
อาจมีกรณีที่ใส่สีซ้ำหรือใส่สีสลับ
```
...
```text
Step 1: รับค่า str
Step 2: ตรวจสอบว่าแม่สีตรงกับเงื่อนไขใน if elif else ไหม
Step 3: ถ้าตรงให้ print ออกมาตามที่ได้กำหนดไว้
Step 4: ถ้าไม่ตรงให้ print ว่า Error
```
...
```text
โดยรวมคือเหมือนแผนแรก แต่มีการปรับเปลี่ยนเพราะลืมกรณีที่ใส่สีสลับ จึงทำให้บาง Testcase ไม่ผ่าน จึงไปเพิ่มเงื่ิอนไขในกรณีที่ใส่สีสลับ จนทำให้ผ่าน
```
...
```text
เช็คกรณีที่อาจมีตัวพิมพ์ ใหญ่-เล็ก
```
