...
| OJ submission ID, if submitted | https://ijudge.it.kmitl.ac.th/submissions/565846/overview |
| OJ status | Pass |
...
```text
เช็คหน่อยครับว่าผิดพลาดตรงไหนรึป่าว ห้ามบอก code
```
...
```text
AI บอกให้ลองคิดดูว่าถ้า testcase มันไม่ลงตัวเสมอไป ทำไง?
```
...
```text
ผมได้ตรวจสอบแล้วก็นึกออกว่าเราควรหารด้วย modulo ก่อน แล้วนำค่ามาลบกับตัวเดิม เพื่อให้สามารถาหารได้ลงตัว
```
...
```text
ได้เรียนรู้ว่าควรคิดเผื่อหลายๆกรณี และได้รู้ว่า modulo ได้ใช้มากกว่าที่คิด
```
