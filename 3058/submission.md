...
```text
https://ijudge.it.kmitl.ac.th/submissions/609981/overview
```
...
```text
โจทย์ให้สร้าง Program ที่ใช้ในการคำนวณก้อนหินในการต่อสะพาน โดยจะมีหิน A B

Input: รับค่าหิน A B และ Goal เป็นจำนวนเต็ม

Output:
Program จะ print ออกมาเป็นจำนวนหินก้อนเล็กที่ต้องใช้

Constraints:
จำเป็นต้องใช้หินก้อนเล็กให้หมด โดยต้องใช้ให้น้อยที่ีสุด
```
...
```text
Step 1: อ่านค่าจำนวนเต็ม
Step 2: เช็คค่า B ทั้งหมด
Step 3: หาว่าพอลบ B ไปแล้วเหลือเท่าไหร่ 
Step 4: ถ้าลบแล้วเหลือ 0 print 0
Step 5: ถ้าลบแล้วกับลบ A ไม่เท่ากับ 0 print -1 (สร้างไม่ได้)
Step 6: เข้่า loop นำ A ไปลบจนกว่าจะ 0 แล้ัว +ค่าไปเรื่อยเพื่อนับ
Step 7: print คำตอบ
```
...
```text
เปลี่ยนการเช็คกรณี -1 ให้เช็คเมื่อ หิน B + A น้อยกว่า Goal หรือ B ที่เหลือน้อยกว่า A
เปลี่ยนการเช็คกรณี 0 ให้เช็คเมื่อ B มากกว่า Goal และ หิน B เหลือไม่เท่ากับ 0
ถ้า B น้อยกว่า Goal ให้ print(goal - b info)
นอกนั้นให้ print หินที่เหลือต้องต่อ
```
