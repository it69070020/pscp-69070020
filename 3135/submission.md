...
```text
https://ijudge.it.kmitl.ac.th/submissions/641198/overview
```
...
```text
โจทย์ให้ทำ program ในการวิเคราะห์คนที่จะได้พิจารณาของขวัญ

Input:
ราคา n สามตัวเป็น จำนวนคน, จำนวนทื่บวก, คนที่ขโมย

Output:
คนที่ได้พิจารณาของขวัญ

Constraints:
อาจเป็นคนแรกเลยก็ได้ ที่เป็นขโมย
```
...
```text
Step 1: รับค่าทั้ง 3 ตัวเป็นจำนวนเต็ม
Step 2: นับ ppl และ count = 1 ไว้เ้พราะเป็นคนแรก
Step 3: เช็คโดยใช้สมการ (ppl - 1 + K) % N + 1 ใน loop เพื่อวน
Step 4: ถ้าเจอคนที่ 1 ให้หยุด แล้ว count += 1
Step 5: ถ้าเจอขโมยหยุดทันที
Step 6: print จำนวนคนที่ได้พิจารณา
```
...
```text
เหมือนกับวิธีแรกแต่มีการเพิ่มดักให้ตรวจสอบกรณีที่คนแรกดันเป็นขโมย ให้หยุดทำงานทันที
```
