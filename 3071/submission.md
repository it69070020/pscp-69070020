...
```text
https://ijudge.it.kmitl.ac.th/submissions/589150/overview
```
...
```text
โจทย์ให้ทำ program คำนวณ จำนวนในช่วง [A,B] ที่หารด้วย d เหลือเศษ r

Input:
รับค่า 4 ตัว เป็นจำนวนเต็ม

Output:
print ค่าหลังคำนวณออกมา

Constraints:
ใช้ modulo หาเพื่อเอาเศษ
```
...
```text
Step 1: อ่านค่าจำนวนเต็มทั้ง 4 ตัว
Step 2: กำหนด count เป็น 0 เพื่อรอบวกค่า
Step 3: ใช้ loop ในการคำนวณ (A, B + 1)
Step 4: ถ้า x % d == r ให้ count += 1
Step 5: print count ออกมา
```
