...
```text
https://ijudge.it.kmitl.ac.th/submissions/659682/overview
```
...
```text
โจทย์ให้ทำ program การผสมสีโดยใช้ค่า RGB

Input:
รับค่าเป็นค่าสี RGB ของทั้งสองสี 

Output:
จะออกมาเป็นค่าสีหลังจากผสมแล้ว

Constraints:
สามารถสังเกตได้ว่าสีหลังผสมจะไม่มีทางเกิน 255
```
...
```text
Step 1: รับค่าสี ของที่งสองสีอย่างละ 3 ค่า (RGB)
Step 2: นำค่าสีที่ตรงกันมาบวกกันแล้วหาร 2 ปัดเศษ
Step 3: print ออกมาเป็นค่าสีที่ได้
```
