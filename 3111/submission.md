...
```text
https://ijudge.it.kmitl.ac.th/submissions/628215/overview
```
...
```text
โจทย์ให้ทำ program ที่คำนวณราคาที่ต้องจ่ายสำหรับซื้อสินค้าจากสหกรณ์ผ่านระบบ member and discount

Input:
รับค่าเป็น str สำหรับสมาชิก ที่เหลือเป็นจำนวนเต็ม

Output:
print ออกมาเป็นจำนวนเงินที่ต้องจ่ายทศนิยม 2 ตำแหน่ง

Constraints: 
อาจมี floating point precision issue เพราะคอมพิวเตอร์อาจเก็บค่า 71.72499999999999... ไม่ใช่ 71.72
```
...
```text
Step 1: อ่านค่า int กับ str
Step 2: ให้ price = 0 เพื่อบวกค่าเข้าไป
Step 3: เข้า loop เพื่อรับค่าทั้งหมด
Step 4: ถ้าเป็น member ลด 5%
Step 5: ไม่เป็น แต่ซื้อถึง 500 ลด 3%
Step 6: result ให้ เอาราคาทั้งหมดคูณ 100 บวก 0.5 หาร 100
Step 7: print result
```
...
```text
เหมือนเดิมหมด แต่มีการเพิ่มให้ + 1e-9 เพื่อแก้ปัญหา floating point precision issue 
พอเราคูณ 100 → ได้ 7172.499999999... แล้ว +0.5 → 7172.999999999... แล้ว int() ตัดทศนิยมทิ้ง → ได้ 7172 ไม่ใช่ 7173 เลยกลายเป็น 71.72 แทนที่จะเป็น 71.73
```
