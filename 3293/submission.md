...
```text
https://ijudge.it.kmitl.ac.th/submissions/656572/overview
```
...
```text
โจทย์ให้ทำ program ในการใส่กรอบให้กับข้อความที่รับมา

Input:
รับค่า str 5 บรรทัด

Output:
print ออกมาเป็นข้อความเดิมแต่มีการใส่กรอบด้วย *

Constraints:
กรอบจะคิดจากประโยคที่ยาวที่สุดเสมอและต่อให้ไม่มีประโยค ก็ต้องมีกรอบ
```
...
```text
Step 1: รับค่า str 5 ประโยค
Step 2:  โดยให้นำค่าไปเก็บไว้ใน list
Step 3: จากนั้นใช้ len นับจำนวนตัวทั้งหมดบวกด้วย 4
Step 4: จากนั้น print บรรทัดแรกด้วยการนำ * คูณกับ ค่าที่ได้จาก step 3
Step 5: ไล่ใส่ * ทั้งซ้ายและขวาของทุกประโยค
Step 6: ทำเหมือน step 4
```
...
```text
เหมือนกับวิธีแรกแต่มีการใช้ s.ljust(max_index) เพื่อให้ print ออกมาง่ายขึ้น
```
