...
```text
https://ijudge.it.kmitl.ac.th/submissions/610099/overview
```
...
```text
โจทย์ให้ทำ program ในการรับคาเป็น +,- เพื่อแทนการเพิ่มลดคะแนน

Input:
รับจำนวนเต็ม เพื่อกำหนดขอบเขตของ symbol จากนั้นรับ +,-

Output:
ค่าหลังจาก +,- ครบแล้ว

Constraints:
นับเป็นค่าๆ ง่ายกว่าบอกทีเดียว
```
...
```text
Step 1: รับค่า n
Step 2: รับ +,- ตามที่กำหนดไว้ที่ n
Step 3: เมื่อเป็น + เพิ่ม plus 1 เมื่อเป็น - เพิ่ม minus 1
Step 4: + คูณ 10 - คูณ 5
Step 5: นำ plus, minus มาลบกัน
Step 6: print result
```
