...
```text
https://ijudge.it.kmitl.ac.th/submissions/646147/overview
```
...
```text
โจทย์ให้ทำ program ในการบอกชื่อไพ่จากชื่อย่อ
...
Constraints:
ข้อนี้ต้องใช้ string slicing ต้องดู index ให้ดีๆ
```
...
```text
Step 1: รับ str เข้ามา
Step 2: ถ้าตัวแรกเป็น 23456789 หรือ 10 ให้เช็คต่อ
Step 3: ถ้าเป็น D, H, S, C ให้นำ index ของเลขมาต่อด้วย of (ชื่อ)
Step 4: ถ้่าไม่ใช่ให้ print ตรงตามชื่อย่อ Ex. JD = jack of diamonds
```
...
```text
เหมือนกับวิธีแรกทุกประการแต่ใช้ Upper ตรง input เพราะพึ่งเห็นตอนหลังว่าโจทย์อาจใส่ตัวเล็ก
```
