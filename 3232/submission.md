...
```text
https://ijudge.it.kmitl.ac.th/submissions/648945/overview
```
...
```text
โจทย์ให้ทำ program ในการคำนวณการกระโดดของกบ

Input:
จำนวนเต็ม 2 ตัว (x,y)

Output:
จำนวนครั้งที่กบต้องกระโดดไปให้ถึง y

Constraints:
มันตั้งเริ่มนับ 1 เพราะมันกระโดดก่อนเลย 1 ครั้งที่ x
```
...
```text
Step 1: รับค่า int 2 ตัว (x,y)
Step 2: นำ x มาลบ y ทันทีเพื่อหาจำนวนที่เหลือ
Step 3: ตั้ง count = 0 เตรียมนับ
Step 4: ให้ new_x = x
Step 5: ใช้ for loop วน +count -new_x แล้วเอาไปลบกับ จำนวนกระโดดที่เหลือจนกว่าจะ 0
Step 6: ถ้าจำนวนที่ต้องกระโดดที่เหลือ ยังมากกว่า 0 ให้ print -1
Step 7: ถ้าหมดให้ print จำนวนที่กระโดด
```
...
```text
เปลี่ยนไปใช้ while loop แทนเพราะง่ายกว่าและเรายังไม่รู้จำนวนที่แน่นอนจริงๆ และเปลี่ยน count เป็น 1 เพราะเรากระโดดตั้งแต่ตอน x
```
