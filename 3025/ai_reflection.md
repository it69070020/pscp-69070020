...
| OJ submission ID, if submitted | https://ijudge.it.kmitl.ac.th/submissions/559879/overview |
| OJ status | Pass |
...
```text
เช็คหน่อยครับว่าผิดพลาดตรงไหน ใบ้มาให้หน่อย อย่าเพิ่งบอก code
```
...
```text
AI บอกว่าให้ลองดูที่ conditions ตรงเดือนที่ 3 หารไม่ลงตัวดีๆว่า ควรแปรผันตามวันที่เขียนไว้ก่อนรึป่าว
```
...
```text
ผมเลยกลับไปตรวจสอบ และก็ได้เข้าใจว่าเดือนที่ 3 หารไม่ลงตัว ควรตาม season ตลอด ผมเลยเขียนเงื่อนไขเพิ่มว่า ต้องเป็นกรณีที่เป็นเดือน 3 หารลงตัวเท่านั้นถึงจะพิจารณาแยก
```
...
```text
ได้เรียนรู้ว่าผมควรวิเคราะห์ condition ให้ดี และเขียนให้สัมพันธ์กับกรณีที่โจทย์ให้
```
