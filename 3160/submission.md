...
```text
https://ijudge.it.kmitl.ac.th/submissions/640727/overview
```
...
```text
โจทย์ให้ทำ program ในการตรวจสอบว่าในช่วงที่เรากำหนดนั้นมีจำนวนเฉพาะอะไรบ้าง และมีทั้ิงหมดกี่ตัว

Input:
ช่วงของเลขเริ่มต้นและเลขสุดท้าย

Output:
program จะเช็คว่าจำนวนเฉพาะที่อยู่ในช่วงนั้นมีกี่ตัวและมีอะไรบ้าง โดย print จากค่าที่เก็บไว้ใน list

Constraints: เป็นจำนวนเต็มสองค่า คั่นด้วยช่องว่าง ค่าทั้งสองอาจไม่เรียงลำดับก็ได้
```
...
```text
Step 1: อ่านจำนวนเต็มสองค่า
Step 2: ใช้ loop ตรวจสอบว่าเป็นจำนวนเฉพาะกี่ตัวและมีอะไรบ้าง
Step 3: เก็บค่าที่ได้ไว้ใน list 
Step 4: ข้อมูลทั้งหมดคั่นด้วยช่องว่าง
Step 5:print ทั้งค่าของจำนวนเฉพาะ และจำนวนที่ได้
```
...
```text
เหมือนกับวิธีแรกแต่มีการเพิ่มif prime: print(*prime) เพราะกรณีที่เป็น 0 มันไม่ควร print ไม้งั้นจะเกิดช่องว่าง ทำให้ผิด 
```
