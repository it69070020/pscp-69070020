...
```text
https://ijudge.it.kmitl.ac.th/submissions/575416/overview
```
...
```text
โจทย์ให้สร้าง Program ในการเช็คว่าเกิดการ Surprise รึป่าวจากการที่อันดับสูงสุดกับต่ำสุดต้องห่างกัน 2

Input:
Program รับค่าเป็นจำนวนจริง

Output:
ถ้าเช็คแล้วว่าห่างกันสองจริงให้ print Surprising ถ้าไม่ print Not surprising

Constraints:
มีโอกาสที่ค่าอาจติดลบ จึงควรมีการเปลี่ยนค่าก่อนเข้า loop
```
...
```text
Step 1: อ่านจำนวนจริง
Step 2: นำค่าสูงสุดมา x2 แล้วลบด้วย total
Step 3: ถ้ามากกว่าหรือเท่ากับ 2 print "Surprising"
Step 4: ถ้าไม่ print "Not surprising"
```
...
```text
เหมือนกับแผนเดิม แต่มีการเพิ่มการดักค่านกรณีต่ำกว่า 0 ให้เป็น 0 เพื่อคำนวณต่อไป ที่เหลือเหมือนเดิม
```
...
```text
บอกผมว่าให้ลองดัก 0 ก่อน loop
```

คุณยังทำอะไรด้วยตนเอง

```text
นั่งเขียนต่อว่าจะดักตั้งแต่ตัวแปรเลย
```
